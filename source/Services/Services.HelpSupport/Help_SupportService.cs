namespace Services.HelpSupport
{
    ...
    public static class Help_SupportService
    {
        ...
        private static void InitializeActivities()
        {
            //Computer tasks
            {
                Activities.Add(new Activity("Make a new folder", ActivityDescription.GenericFolder));
                Activities.Add(new Activity("Publish this folder to the Web", ActivityDescription.GenericFolder));
                Activities.Add(new Activity("Share this folder", ActivityDescription.GenericFolder));
            }
            ...
            {
                Activities.Add(new Activity("My Network Places", ActivityDescription.PlaceLink));
                Activities.Add(new Activity("My Documents", ActivityDescription.PlaceLink));
                Activities.Add(new Activity("Shared Documents", ActivityDescription.PlaceLink));
                Activities.Add(new Activity("Control Panel", ActivityDescription.PlaceLink));
            }
        }
        #endregion
    }
